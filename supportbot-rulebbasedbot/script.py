...
class SupportBot:
  ...
  def welcome(self):
    ...
    will_help = input("Ok {}, what can I help you with? ".format(self.name))
  ...
  def how_to_pay_bill_intent(self):
    return input("You can pay your bill a couple of ways. 1) online at bill.codecademybank.com or 2) you can pay your bill right now with me. Can I help you with anything else, {}? ".format(self.name))
  
  def pay_bill_intent(self, account_number=None):
    return input("The account with number {} was paid off. What else can I help you with?".format(account_number))
